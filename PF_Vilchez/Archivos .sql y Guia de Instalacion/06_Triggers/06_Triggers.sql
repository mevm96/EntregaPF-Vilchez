...
-- El proposito de este Trigger es asegurar que el año de lanzamiento de un album este dentro de un rango en especifico y adicionalmente,
-- dar un valor default de duracion a un album si no lo tiene y por ultimo, la creacion del registro del entry o record 
-- en la tabla de auditoria especifica para modificaciones en la tabla album.
